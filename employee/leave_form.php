          ...
          <div class="card-body">
            ...
            <form method="post" action="leave_form2.php">
              <div class="form-group">
                ...
                <select name="leave" class="form-control" id="leave-type">
                  <option value="" name="leave_type">Select Leave</option>
                  <option value="" name="leave_type">Sick Leave</option>
                  <option value="" name="leave_type">Casual Leave</option>
                </select>
              </div><br>
              <div class="form-group">
                <label class=" form-control-label" name="date">Start Date</label>
                <input type="date" name="leave_from" class="form-control" id="start-date">
              </div><br>
              <div class="form-group">
                <label class="form-control-label">End Date</label>
                <input type="date" name="leave_to" class="form-control" id="end-date">
              </div><br>
              <div class="form-group">
                <label class="form-control-label">Reason</label>
                <textarea name="leave_description" class="form-control" id="reason" rows="3"></textarea>
              </div><br>
              <!-- <div class="form-group">
