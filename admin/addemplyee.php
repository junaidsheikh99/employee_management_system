                  ...
                  <table border="1" style="background-color: white;">
                    <h2>HR Form</h2>
                           <tr>
                            ...
                            <tr>
                                <th>Phone Number</th>
                                <td><input type="text" name="mob" maxlength="10" pattern="\d{10}" placeholder="Enter 10 Digit Number" required></td>
                                <!-- <th>Experience</th> -->
                                <!-- <td>
                                ...
                                <th id="experience-years">Experience Years</th>
                            ...
                            <tr>
                                ...
                                <th>District</th>
                                <td><input type="text" name="dist" placeholder="Enter District" required></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <div class="autocomplete" style="width:300px;">
                                    <input id="myInput" type="text" name="mycon" placeholder="Country" required>
                                  </div>
                                </td>

                                <tr>
                                    <th>DOB</th><td><input type="date" id="birthday" name="dob" required></td>
                                    <th>Gender</th>
                                    <td>
                            ...
                            <tr>
                                <th>HR ID</th>
                                <td><input type="text" name="hrid" placeholder="Employee Id" required></td>
                                <th>Department</th>
                                <td><input type="text" name="dept" placeholder="Department" required></td>
                            </tr>
                            <tr>
                                <!-- <th>Position</th>
                                <td><input type="text" name="pstn" placeholder="Job Title" required></td> -->
                                <th>Start Date</th>
                                <td><input type="date" name="sdate" required></td> <tr>
                            </tr>
                            ...
                            <tr><th colspan="4">Password <input type="password" name="pass" class="input" data-type="password" maxlength="20" pattern="\d{@0-9a-z}" required></th>
    ...
    if(isset($_POST['submit']))
     {
        ...
        $qry="INSERT INTO `hr_table`(`fname`, `mname`, `lname`, `email`, `mob`, `expyr`, `city`, `dist`, `state`, `country`, `dob`, `gender`, `hr_id`, `dept`, `sdate`, `salary`, `image`, `pass`, `status`) VALUES ('$fname','$mname','$lname','$email','$phone','$expyr','$city','$dist','$state','$country','$dob','$gender','$hrid','$dept','$sdate','$salary','$imagename','$pass','$status')";
