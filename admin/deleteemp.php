 ...
 if(isset($_POST['submit']))
  {
      ...
      $hrid=$_POST['hr_id'];
      $fname=$_POST['fname'];
      $sql="SELECT * FROM `hr_table` WHERE hr_id='$hrid' AND 'fname' LIKE '%fname%'";
            ...
            $count++;
             ...
             <tr align="center">
               <td><?php echo $count; ?></td>
                ...
                <td><a href="empdeleteform.php?sid=<?php echo $data['hr_id']?>" onclick="return confirm('Are you sure you want to delete this record?');">
