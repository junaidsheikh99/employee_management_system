...
<body>
                <div align="center">
                  ...
                  <form action="deleteman.php" method="post">
 ...
 if(isset($_POST['submit']))
  {
      ...
      $emp_id=$_POST['empid'];
      $fname=$_POST['fname'];
      $sql="SELECT * FROM `manager` WHERE emp_id='$emp_id' AND 'fname' LIKE '%fname%'";
            ...
            $count++;
             ...
             <tr align="center">
               <td><?php echo $count; ?></td>
                ...
                <td><a href="mandeleteform.php?sid=<?php echo $data['emp_id']?>" onclick="return confirm('Are you sure you want to delete this record?');">
