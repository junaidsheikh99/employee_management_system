...
<body>
    <div class="updemp" align="center">
        ...
        <form action="updateman.php" method="post">
  ...
  if(isset($_POST['submit']))
  {
      ...
      $id=$_POST['emp_id'];
      $fname=$_POST['fname'];
      $sql="SELECT * FROM `manager` WHERE emp_id='$id' AND 'fname'  LIKE '%fname%'";
             ...
             <tr align="center">
               <td><?php echo $count; ?></td>
                ...
                <td><?php echo $data['emp_id'] ?></td>
                 <td><a href="manupdateform.php?sid=<?php echo $data['emp_id']?>" style="color:white; background-color: #000; border-radius:5px;padding:5px 6px 4px 6px;">Edit</a></td>
               </tr> 
              <?php
            }
         }
