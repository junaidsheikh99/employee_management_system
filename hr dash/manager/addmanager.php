...
<body>
            ...
            <div class="empad">
                <form autocomplete="off" method="post" action="addmanager.php" enctype="multipart/form-data">
    ...
    if(isset($_POST['submit']))
     {
        ...
        $qry="INSERT INTO `manager`(`fname`, `mname`, `lname`, `email`, `mob`, `experience`, `expyr`, `city`, `dist`, `state`, `country`, `dob`, `gender`, `emp_id`, `dept`, `position`, `sdate`, `salary`, `image`, `pass`) VALUES ('$fname','$mname','$lname','$email','$phone','$exp','$expyr','$city','$dist','$ste','$mycon','$bdy','$gender','$empid','$dept','$pstn','$sdate','$salary','$imagename','$pass')";
